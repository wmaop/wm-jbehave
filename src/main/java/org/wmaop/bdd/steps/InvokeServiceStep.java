...
public class InvokeServiceStep extends BaseServiceStep {
	...
	protected void execute(ExecutionContext executionContext) throws Exception {
		...
		if (override != null) {
			mergeNestedTypes(override, inputPipeline);
		}
		IData pipeline = invokeService(executionContext, serviceName, inputPipeline);
		executionContext.setPipeline(pipeline);
	}
	
	private static void mergeNestedTypes(IData override, IData inputPipeline){
	...
	private static IData[] mergeNestedTypes(IData[] overrideArray, IData[] inputPipelineArray){
